...
insert into amf_providers_config(provider_config_id,provider_type,providers,user_audit_info) values (gen_random_uuid(),'Middleware','IBM,MFTLABS,Amazon','{"created_by": "CMD", "created_on": "2021-01-01 00:00:01.000", "last_modified_by": "", "last_modified_on": ""}');
...
insert into amf_platform_config(platform_config_id,provider,platforms,user_audit_info) values (gen_random_uuid(),'IBM','SFG-TM,SFG-GM,B2Bi,SSP,SSPCM,SEAS,CCM(ICC)','{"created_by": "CMD", "created_on": "2021-01-01 00:00:01.000", "last_modified_by": "", "last_modified_on": ""}');
insert into amf_platform_field_config(platform_field_config_id,provider,platform,field_config,user_audit_info) values (gen_random_uuid(),'IBM','SFG-TM','[
{
"key":            "node_names",
"text":           "Node Names",
"default":        "",
"show":        "true",
"parameter_type": "TEXTBOX",
"required":       "yes",
...
{
"key":            "cd_netmap",
"text":           "SFG API Netmap Name",
"default":        "",
"show":        "true",
"parameter_type": "TEXTBOX",
"required":       "no",
"description":    "SFG API Netmap Name"
},
{
"key":            "routing_rule",
"text":           "Routing Rule Action",
"default":        "",
"show":        "true",
"parameter_type": "TEXTBOX",
"required":       "yes",
"description":    "Routing Rule Action"
}
]','{"created_by": "CMD", "created_on": "2021-01-01 00:00:01.000", "last_modified_by": "", "last_modified_on": ""}');
insert into amf_platform_field_config(platform_field_config_id,provider,platform,field_config,user_audit_info) values (gen_random_uuid(),'IBM','SFG-GM','[ {
"key":            "dc_names",
"text":           "DC Names",
"default":        "",
"show":        "true",
...
"parameter_type": "TEXTBOX",
"required":       "yes",
"description":    "GM Admin User"
} , {
"key":            "gm_admin_password",
"text":           "GM Admin Password",
"default":        "",
"show":        "true",
"parameter_type": "PASSWORD",
"required":       "yes",
"description":    "GM Admin Password"
},{
"key":            "eventrule_name",
...
"key":            "eventrule_bp_name",
"text":           "Event Rule BP Name",
"default":        "",
"show":        "true",
"parameter_type": "TEXTBOX",
"required":       "yes",
"description":    "Event Rule BP Name",
},{
"key": "cd_netmap_external",
"text": "SFG API Netmap Name External",
"default": "",
"show": "true",
"parameter_type": "TEXTBOX",
"required": "no",
"description": "SFG API Netmap Name External"
},
{
"key": "cd_netmap_internal",
"text": "SFG API Netmap Name Internal",
"default": "",
"show": "true",
"parameter_type": "TEXTBOX",
"required": "no",
"description": "SFG API Netmap Name Internal"
}
]','{"created_by": "CMD", "created_on": "2021-01-01 00:00:01.000", "last_modified_by": "", "last_modified_on": ""}');
insert into amf_platform_field_config(platform_field_config_id,provider,platform,field_config,user_audit_info) values (gen_random_uuid(),'IBM','B2Bi','[]','{"created_by": "CMD", "created_on": "2021-01-01 00:00:01.000", "last_modified_by": "", "last_modified_on": ""}');
insert into amf_platform_field_config(platform_field_config_id,provider,platform,field_config,user_audit_info) values (gen_random_uuid(),'IBM','SSP','[]','{"created_by": "CMD", "created_on": "2021-01-01 00:00:01.000", "last_modified_by": "", "last_modified_on": ""}');
insert into amf_platform_field_config(platform_field_config_id,provider,platform,field_config,user_audit_info) values (gen_random_uuid(),'IBM','SSPCM','[
{
"key":"ssp_dmzone",
"text":"DM Zone",
"default": "false",
...
"parameter_type": "TEXTBOX",
"required":       "yes",
"description":    "SSP API User"
},{
"key":            "ssp_api_password",
"text":           "SSP API Password",
"default":        "",
"show":        "true",
"parameter_type": "PASSWORD",
"required":       "yes",
"description":    "SSP API Password"
},{
"key":            "cd_policy",
"text":           "CD Policy",
"default":        "",
...
"parameter_type": "TEXTBOX",
"required":       "no",
"description":    "CD Trust Store"
},{
"key":            "cd_ext_fpxy",
"text":           "CD External Forward Proxy",
"default":        "",
"show":        "true",
"parameter_type": "TEXTBOX",
"required":       "no",
"description":    "CD External Forward Proxy"
},{
"key":            "cd_ext_rpxy",
"text":           "CD External Reverse Proxy",
"default":        "",
"show":        "true",
"parameter_type": "TEXTBOX",
"required":       "no",
"description":    "CD External Reverse Proxy"
},{
"key":            "cd_int_fpxy",
"text":           "CD Internal Forward Proxy",
"default":        "",
"show":        "true",
"parameter_type": "TEXTBOX",
"required":       "no",
"description":    "CD Internal Forward Proxy"
},{
"key":            "cd_int_rpxy",
"text":           "CD Internal Reverse Proxy",
"default":        "",
"show":        "true",
"parameter_type": "TEXTBOX",
"required":       "no",
"description":    "CD Internal Reverse Proxy"
},{
"key":            "ssp_engine_externalhost",
"text":           "SSP Engine External Host",
"default":        "",
"show":        "true",
"parameter_type": "TEXTBOX",
"required":       "no",
"description":    "SSP Engine External Host"
},{
"key":            "ssp_engine_externalport",
"text":           "SSP Engine External Port",
"default":        "",
"show":        "true",
"parameter_type": "TEXTBOX",
"required":       "no",
"description":    "SSP Engine External Port"
},{
"key":            "ssp_engine_internalhost",
"text":           "SSP Engine Internal Host",
"default":        "",
"show":        "true",
"parameter_type": "TEXTBOX",
"required":       "no",
"description":    "SSP Engine Internal Host"
},{
"key":            "ssp_engine_internalport",
"text":           "SSP Engine Internal Port",
"default":        "",
"show":        "true",
"parameter_type": "TEXTBOX",
"required":       "no",
"description":    "SSP Engine Internal Port"
}

]','{"created_by": "CMD", "created_on": "2021-01-01 00:00:01.000", "last_modified_by": "", "last_modified_on": ""}');
insert into amf_platform_field_config(platform_field_config_id,provider,platform,field_config,user_audit_info) values (gen_random_uuid(),'IBM','SEAS','[]','{"created_by": "CMD", "created_on": "2021-01-01 00:00:01.000", "last_modified_by": "", "last_modified_on": ""}');
insert into amf_platform_field_config(platform_field_config_id,provider,platform,field_config,user_audit_info) values (gen_random_uuid(),'IBM','CCM(ICC)','[]','{"created_by": "CMD", "created_on": "2021-01-01 00:00:01.000", "last_modified_by": "", "last_modified_on": ""}');


insert into amf_providers(provider_id, provider_name, description, provider_type,user_audit_info,active) values ('ed8f290d-a76a-48bb-ae98-48331682ad0e','IBM','IBM','Middleware','{"created_by": "CMD", "created_on": "2021-01-01 00:00:01.000", "last_modified_by": "", "last_modified_on": ""}',true);
